...
th2 = cv2.adaptiveThreshold(
    img, 255, cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY, 33, 2
)
th3 = cv2.adaptiveThreshold(
    img, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 33, 2
)
titles = [
    "Original Image",
    "Global Thresholding (v = " + str(threshold) + ")",
    "Adaptive Mean Thresholding",
    "Adaptive Gaussian Thresholding",
]
